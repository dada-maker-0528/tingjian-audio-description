...
export const UI_PROMPTS=Object.freeze([...new Set([
 ...
 ...VOICES.map(v=>'选择音色，'+v.label),VOICE_PREVIEW_TEXT,
 '豆包语音暂时不可用，请稍后重试。已准备的提示仍然可以播放。',
 '这里是你的视频库。按空格创建新视频。按数字键播放当前编号的视频。',
 '请选择视频文件，或者使用演示视频。',
 ...
 `这里是你的视频库，公开片库有 ${films.length} 部视频。当前列表共 ${films.length} 个条目。按 Tab 逐个选择操作，会读出按钮名称。`,
].map(normalizePrompt))]);
