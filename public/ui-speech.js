...
export const UI_PROMPTS=Object.freeze([...new Set([
 ...labels.split('|'),'试听','首个场景','连续场景','进入试听','满意，进入首个场景','满意，进入连续场景','满意，完成整片','再听这段','全屏播放','查看这一段的旁白文本','查看口述旁白文本','重听这段','从头播放','查看角色介绍','旁白大声一点','模拟语音输入',...switches.flatMap(x=>[x+'，已开启',x+'，已关闭']),
