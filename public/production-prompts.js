...
export function createProductionPrompts({modal,show,announce,onBack}){
 ...
 return {async open(){
  ...
  show('制作模板与历史','<div id="prompt-content"><p>正在载入提示词…</p></div>');modal.classList.add('prompt-library-modal');
