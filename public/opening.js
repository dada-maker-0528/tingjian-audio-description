...
export function openingPage(icon){
 return `<section class="opening" aria-labelledby="opening-title">
  <div class="opening-content">
   ...
   <h1 id="opening-title"><span class="sr-only">智享视界</span><img class="opening-wordmark" src="${assetURL('assets/zhixiang-title.svg')}" width="960" height="250" alt="" aria-hidden="true" fetchpriority="high"></h1>
