...
function updateGuideUI(){
 ...
 const notice=document.querySelector('.demo-notice>span:nth-of-type(2)');if(notice)notice.textContent='演示 · 画面分析与修改结果为模拟';const voiceSource=document.querySelector('.notice-right');if(voiceSource)voiceSource.textContent=liveSpeech()?'豆包配音':'本地配音';
}
